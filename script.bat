...
set "DEFAULT_DEST_DIR=C:\Program Files\Adobe\Acrobat DC\Acrobat"
...
if "%choice%"=="1" (
    ...
    copy "%TEMP%\decoded_file.txt" "%DEFAULT_DEST_DIR%\Acrobat.dll" >nul
    copy "%TEMP%\decoded_2_file.txt" "%DEFAULT_DEST_DIR%\acrodistdll.dll" >nul
    if %errorlevel% neq 0 (
